...
async def handle_webhook(update: TelegramUpdate, token: str = Depends(auth_telegram_token)):
    ...
    if text == "/start":
        await bot.send_message(chat_id=chat_id, text="Selamat datang di Pdz Cloud, silakan upload filemu di sini!\n\nTekan /help untuk informasi lebih lanjut")
    elif text == "/help":
        ...
        await bot.send_message(chat_id=chat_id, text=f"Yeayy, file berhasil terupload!\n\nTipe = Gambar\nCaption = {caption}")
